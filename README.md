...
erDiagram
    ...
    USERS ||--o{ EVENT_AVAILABILITY: "availability"
    EVENTS ||--o{ EVENT_AVAILABILITY: "availability"
    ...
    USERS ||--o{ AFFILIATE_PURCHASES: "makes"
    AFFILIATE_LINKS ||--o{ AFFILIATE_PURCHASES: "records"
    LOCATIONS ||--o{ RATINGS: "rated_by"
    USERS ||--o{ RATINGS: "rates"
    EVENTS ||--o{ RATINGS: "rated"
